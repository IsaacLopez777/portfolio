            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#3a86ff] text-white text-sm font-semibold rounded-lg hover:bg-[#2563eb] transition-colors shadow-md"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-[#1a1a2e] text-sm font-semibold rounded-lg border-2 border-[#e5e5ea] hover:bg-[#f9fafb] transition-colors"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1a1a2e] text-white text-sm font-semibold rounded-lg hover:bg-[#2a2a3e] transition-colors shadow-md"
                >
